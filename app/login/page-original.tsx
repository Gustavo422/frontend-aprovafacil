...
export default function LoginPage() {
  ...
  useEffect(() => {
    // This part of the logic needs to be adapted if there's no local user context
    // For now, it will always redirect if not loading, as there's no user to check.
    // If the intent was to prevent rendering if logged in, this logic needs to be re-evaluated.
    // For now, it will always render the login form.
    
    // Using a simple variable to avoid the complex expression in dependencies
  }, []);
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      toast({
        variant: 'destructive',
        title: 'Erro ao fazer login',
        descricao: 'Ocorreu um erro ao tentar fazer login. Tente novamente.',
      });
    } finally {
      setIsLoading(false);
    }
  ...
  // This logic needs to be adapted if there's no local user context
  // For now, it will always render the login form.
  // if (user) {
  //   return null;
  // }
