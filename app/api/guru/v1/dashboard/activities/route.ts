...
export async function GET(request: Request) {
  try {
    console.log('[DEBUG] GET /api/guru/v1/dashboard/activities');
    ...
    const urlConfig = getBackendUrl(guruNewModuleEndpoint.activities, new URL(request.url).search);
    ...
    logger.error('Erro ao buscar guru activities:', {
